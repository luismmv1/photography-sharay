    ...
    const experiences = [
        {
          ...
          description:
            "Más de 10 años capturando momentos inolvidables, desde bodas hasta eventos corporativos.",
          image: "/about/about8.jpg", // Ruta de imagen
        },
        {
          title: "Diseñador de Contenidos Digitales",
          description:
            "Creación de contenido atractivo para redes sociales y proyectos digitales innovadores.",
          image: "/about/about9.jpg", // Ruta de imagen
        },
        {
          title: "Creador de Estrategias Visuales",
          description:
            "Desarrollo de estrategias visuales para marcas, desde campañas de marketing hasta branding.",
          image: "/about/about10.jpg", // Ruta de imagen
        },
      ];
    return (
        <div>
                ...
                <div className="container mx-auto space-y-16">
                    ...
                    >
                        <div className="lg:w-1/2">
                            <Image
                                src="/about/perfil.jpg" // Reemplaza con tu ruta de imagen
                    ...
                    >
                        <div className="lg:w-1/2">
                            <Image
                                src="/about/perfil1.jpg" // Reemplaza con tu ruta de imagen
